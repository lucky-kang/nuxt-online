<template>
  <div class="itemCoat" @click="toDetail(shopObj.id)">
    ...
    <div class="shopPrice">
      <p class="price1">
        {{shopObj.moneyFu!='₫'?shopObj.moneyFu:''}}{{shopObj.shop_price}}{{shopObj.moneyFu=='₫'?shopObj.moneyFu:''}}
      </p>
      <div v-if="shopObj.shop_price!=shopObj.reference_price">
        <span
          class="price2"
        >{{shopObj.moneyFu!='₫'?shopObj.moneyFu:''}}{{shopObj.reference_price}}{{shopObj.moneyFu=='₫'?shopObj.moneyFu:''}}</span>
      </div>
    </div>
  </div>
</template>
